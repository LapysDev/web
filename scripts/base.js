        ...
        push: function push(elements) {
          for (var length = arguments.length, index = 0; index !== length; ++index, ++this.length) {
            ...
            for (var depth = this.depth; depth--; ) {
              // array.length /
              array = array[(Constant.MAXIMUM_DEPTH_ARRAY_LENGTH <= array.length ? Constant.MAXIMUM_DEPTH_ARRAY_LENGTH : array.length) - 1];
            }
            ...
            if (Constant.MAXIMUM_DEPTH_ARRAY_LENGTH === array.length) {
              ...
              if (maximized) {
                ...
                array.parent    = this;
                subarray.depth  = this.depth;
                subarray.length = this.length;
                subarray.parent = this;
                this[0]         = subarray;
                this[1]         = array;
                this.depth     += 1;
            ...
            for (array[array.length] = arguments[index]; this !== array; array = array.parent)
            ++array.length
          }
